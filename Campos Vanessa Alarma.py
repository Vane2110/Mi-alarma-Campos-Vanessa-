...
texto1 = Label(ventana, text= 'Hora', bg= 'black', fg= 'white', font= ('Arial',12, 'bold'))
texto1.grid(row=1, column=0, padx =8, pady=8)
texto2 = Label(ventana, text= 'Minutos', bg= 'black', fg= 'white', font= ('Arial',12, 'bold'))
texto2.grid(row=1, column=1, padx =8, pady=8)
texto3 = Label(ventana, text= 'Segundos', bg= 'black', fg= 'white', font= ('Arial',12, 'bold'))
texto3.grid(row=1, column=2, padx =8, pady=8)

combobox1 = ttk.Combobox(ventana, values = lista_horas , style = "TCombobox", justify='center',width='12', font='Arial')
combobox1.grid(row=2, column=0, padx =15, pady=8)
combobox1.current(0)
combobox2 = ttk.Combobox(ventana, values = lista_minutos , style = "TCombobox", justify='center',width='12', font='Arial')
combobox2.grid(row=2, column=1, padx =15, pady=8)
combobox2.current(0)
combobox3 = ttk.Combobox(ventana, values = lista_segundos , style = "TCombobox", justify='center',width='12', font='Arial')
combobox3.grid(row=2, column=2, padx =15, pady=8)
combobox3.current(0)
style = ttk.Style()
...
alarma = Label(ventana,  fg = 'green', bg='black', font = ('Radioland', 20))
